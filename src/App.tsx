...
export default function App() {
  ...
  return (
    <div ref={containerRef} className="w-screen h-screen overflow-hidden relative bg-bg-snow">
      {/* Progress bar */}
      ...
      {!scrollLocked && (
        <motion.button
          ...
          className="fixed bottom-6 left-6 z-50 p-3 rounded-full glass-strong text-text-mid hover:text-orange-primary hover:scale-110 transition-all shadow-lg"
      ...
      >
        ...
        {/* Screens 6-11: Pitch projects */}
        {PROJECTS.map((project, i) => (
          <PitchTemplate key={project.id} project={project} screenIndex={i + 6} />
        ))}
